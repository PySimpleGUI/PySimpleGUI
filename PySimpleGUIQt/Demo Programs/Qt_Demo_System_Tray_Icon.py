...
layout =  [
            [sg.Text('Press Message to show message using bubble in system tray') ],
            [sg.Text('Note that on some windows configurations these message are blocked') ],
            [sg.Button('Message'), sg.Button('Hide'), sg.Button('UnHide')]
          ]
